...
function ConditionalRenderingDemo() {
  ...
  const [messages] = useState(['Message 1', 'Message 2', 'Message 3']);
      ...
      <div className="demo-box">
        ...
        <div className="example">
          ...
          <div className="output-box">
            ...
            <button onClick={() => setIsButtonActive(!isButtonActive)} style={{ marginLeft: '10px' }}>
              Toggle Button State
            </button>
          </div>
        </div>
        ...
        <div className="example">
          ...
          <div className="output-box">
            ...
            <div style={{ marginTop: '10px' }}>
              ...
              <button onClick={() => setStatus('idle')} style={{ marginLeft: '5px' }}>Idle</button>
            </div>
          </div>
        </div>
      </div>
